...
from .models import BatimentInternat, Chambre, OccupantChambre, EtudeSurveillee
...
class BatimentInternatSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'nom', 'adresse', 'nb_etages',
            'nb_chambres', 'nb_places', 'created_at',
        ]
...
class ChambreListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Chambre
        fields = [
            'id', 'batiment', 'batiment_nom',
            'numero', 'etage', 'type', 'type_display',
            'capacite', 'nb_occupants', 'places_disponibles',
        ]
    
    def get_nb_occupants(self, obj):
        from django.utils import timezone
        today = timezone.now().date()
        return obj.occupants.filter(
...
class ChambreDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'batiment', 'batiment_nom',
            'numero', 'etage', 'type', 'type_display',
            'capacite', 'equipements', 'created_at',
        ]
        read_only_fields = ['id', 'created_at']
...
class OccupantChambreSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'chambre', 'chambre_numero', 'batiment_nom',
            'eleve', 'eleve_matricule', 'eleve_nom', 'eleve_classe',
            'date_debut', 'date_fin', 'motif_fin', 'created_at',
        ]
        read_only_fields = ['id', 'created_at']
...
class EtudeSurveilleeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'batiment', 'batiment_nom', 'salle',
            'date', 'heure_debut', 'heure_fin',
            'surveillant', 'surveillant_nom',
            'eleves_presents', 'nb_presents', 'created_at',
        ]
        read_only_fields = ['id', 'created_at']
