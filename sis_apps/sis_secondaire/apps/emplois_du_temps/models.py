...
class Creneau(models.Model):
    ...
    matiere = models.ForeignKey(Matiere, on_delete=models.PROTECT, related_name="creneaux")
    enseignant = models.ForeignKey(Personnel, on_delete=models.PROTECT, related_name="creneaux")
    salle = models.ForeignKey(Salle, on_delete=models.SET_NULL, null=True, blank=True, related_name="creneaux")
    ...
    date_specifique = models.DateField(null=True, blank=True, help_text="Si défini, créneau ponctuel")
...
class Contrainte(models.Model):
    ...
    enseignant = models.ForeignKey(
        Personnel, on_delete=models.CASCADE, null=True, blank=True, related_name="contraintes"
    )
    salle = models.ForeignKey(
        Salle, on_delete=models.CASCADE, null=True, blank=True, related_name="contraintes"
    )
    classe = models.ForeignKey(
        Classe, on_delete=models.CASCADE, null=True, blank=True, related_name="contraintes"
    )
