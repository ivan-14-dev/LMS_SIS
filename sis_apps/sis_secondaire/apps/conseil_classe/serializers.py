...
from .models import ConseilClasse, DecisionConseil, AppreciationConseil
...
class ConseilClasseListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'periode', 'periode_nom',
            'date', 'president_nom',
            'statut', 'statut_display', 'nb_decisions',
        ]
...
class DecisionConseilSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'moyenne_generale', 'rang', 'motif', 'created_at',
        ]
        read_only_fields = ['id', 'created_at']
...
class AppreciationConseilSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'conseil',
            'eleve', 'eleve_matricule', 'eleve_nom',
            'appreciation', 'projet_orientation',
        ]
        read_only_fields = ['id']
