...
class MenuSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Menu
        fields = [
            'id', 'date', 'entree', 'plat', 'accompagnement', 'dessert',
            'regime', 'regime_display', 'prix',
        ]
        read_only_fields = ['id']
...
class InscriptionCantineSerializer(serializers.ModelSerializer):
    ...
    forfait_display = serializers.CharField(source='get_forfait_display', read_only=True)
    regime_display = serializers.SerializerMethodField()
    ...
    class Meta:
        ...
        fields = [
            ...
            'date_debut', 'date_fin',
            'regime', 'regime_display', 'allergies',
            'actif', 'created_at',
        ]
...
class PresenceCantineSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'menu', 'menu_date', 'menu_plat',
            'eleve', 'eleve_matricule', 'eleve_nom',
            'present', 'heure_pointage', 'created_at',
        ]
        read_only_fields = ['id', 'created_at']
