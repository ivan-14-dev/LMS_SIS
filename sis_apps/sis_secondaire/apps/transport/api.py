...
class LignesTransportViewSet(viewsets.ModelViewSet):
    ...
    def inscrits(self, request, pk=None):
        ...
        inscriptions = ligne.inscriptions.filter(actif=True).select_related(
...
class InscriptionsTransportViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return InscriptionTransport.objects.select_related(
            'eleve__user', 'eleve__classe', 'ligne',
            'arret_montee', 'arret_descente', 'annee_scolaire'
        )
    ...
    def statistiques(self, request):
        ...
        stats['par_ligne'] = {l['ligne__nom']: l['count'] for l in by_ligne}
