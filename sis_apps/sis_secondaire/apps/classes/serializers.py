...
class ClasseListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'prof_principal', 'prof_principal_nom',
            'effectif_max', 'effectif', 'color',
        ]
...
class GroupeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Groupe
        fields = [
            'id', 'etablissement', 'annee_scolaire', 'nom',
            'type', 'type_display', 'capacite',
            'classes', 'classes_noms', 'created_at',
        ]
...
class MatiereDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Matiere
        fields = [
            'id', 'etablissement', 'code', 'nom',
            'type', 'type_display', 'couleur',
            'coefficient_defaut', 'description',
            'created_at',
        ]
        read_only_fields = ['id', 'created_at']
