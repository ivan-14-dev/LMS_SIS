...
class DossierMedicalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'observations', 'date_derniere_visite',
...
class VisiteInfirmerieListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'eleve', 'eleve_matricule', 'eleve_nom', 'eleve_classe',
            'date', 'heure_arrivee', 'heure_sortie',
            'motif', 'orientation', 'orientation_display',
            'infirmier', 'infirmier_nom', 'parents_prevenus',
        ]
...
class VisiteInfirmerieDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'eleve', 'eleve_matricule', 'eleve_nom', 'eleve_classe',
            'date', 'heure_arrivee', 'heure_sortie',
            'motif', 'symptomes', 'soins', 'traitement_administre',
...
class StockMedicamentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'nom', 'description',
            'quantite', 'seuil_alerte', 'unite',
            'date_peremption', 'numero_lot',
            'en_alerte', 'perime', 'created_at', 'updated_at',
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
