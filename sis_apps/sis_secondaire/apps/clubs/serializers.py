...
class ClubListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'responsable_nom', 'horaires',
            'capacite', 'nb_membres', 'actif', 'couleur',
        ]
...
class ClubDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'salle', 'horaires', 'capacite',
            'image', 'couleur', 'date_creation',
            'nb_membres', 'actif', 'created_at',
        ]
...
class SeanceClubSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'activite', 'presents', 'nb_presents', 'created_at',
        ]
        read_only_fields = ['id', 'created_at']
