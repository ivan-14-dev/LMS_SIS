...
class EvaluationListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Evaluation
        fields = [
            'id', 'titre', 'type', 'modalite', 'modalite_display',
            'ecue', 'ecue_nom', 'ecue_code',
...
class EvaluationDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'ecue', 'ecue_nom', 'semestre', 'semestre_libelle',
            'date', 'heure_debut', 'duree_minutes',
            'bareme', 'coefficient', 'modalite', 'modalite_display',
            'enseignant', 'enseignant_nom', 'anonyme',
...
class NoteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'valeur', 'numero_anonyme', 'appreciation',
...
class MoyenneECUESerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'ecue', 'ecue_nom', 'ecue_code', 'semestre',
            'moyenne', 'valide', 'date_calcul',
        ]
...
class MoyenneUESerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'etudiant', 'etudiant_matricule', 'etudiant_nom',
            'ue', 'ue_nom', 'ue_code', 'semestre',
            'moyenne', 'credits_obtenus', 'capitalisee', 'date_calcul',
        ]
        read_only_fields = ['id', 'date_calcul']
