...
from .models import EnseignantChercheur, AffectationEnseignement
...
class EnseignantListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'full_name', 'email', 'numero_harpe',
            'corps', 'corps_display', 'specialite',
            'laboratoire', 'laboratoire_nom', 'h_index',
        ]
...
class EnseignantDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = EnseignantChercheur
        fields = [
            'id', 'user', 'full_name', 'first_name', 'last_name', 'email',
            'numero_harpe', 'corps', 'corps_display', 'specialite',
            'laboratoire', 'laboratoire_nom',
            'h_index', 'orcid', 'id_hal', 'id_ref', 'bibliographie',
            'annee_these', 'directeur_these', 'heures_service',
...
class AffectationEnseignementSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'ue', 'ue_nom', 'ecue', 'ecue_nom',
            'type_enseignement', 'type_display', 'heures',
    ...
    def get_type_display(self, obj):
        return dict(obj._meta.get_field('type_enseignement').choices).get(obj.type_enseignement, '')
...
class EnseignantCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'numero_harpe', 'corps', 'specialite', 'laboratoire',
            'orcid', 'id_hal', 'heures_service',
        ]
