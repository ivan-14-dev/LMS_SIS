...
class EnseignantsViewSet(viewsets.ModelViewSet):
    ...
    search_fields = ['user__first_name', 'user__last_name', 'user__email', 'specialite', 'numero_harpe']
...
class AffectationsViewSet(viewsets.ModelViewSet):
    ...
    filterset_fields = ['enseignant', 'ue', 'ecue', 'type_enseignement', 'annee_universitaire']
