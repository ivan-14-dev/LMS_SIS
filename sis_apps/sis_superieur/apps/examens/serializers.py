...
class SessionExamenSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'numero', 'numero_display', 'type', 'type_display',
            'date_debut', 'date_fin', 'cloturee',
            'nb_epreuves', 'created_at',
        ]
...
class EpreuveExamenListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = EpreuveExamen
        fields = [
            'id', 'session', 'session_numero',
            'ecue', 'ecue_code', 'ecue_nom',
            'date', 'heure_debut', 'duree_minutes',
            'lieu', 'places_totales', 'nb_convoques',
        ]
...
class EpreuveExamenDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'ecue', 'ecue_code', 'ecue_nom',
            'date', 'heure_debut', 'duree_minutes',
            'lieu', 'places_totales', 'anonymat',
            'surveillants', 'surveillants_noms',
            'nb_convoques', 'nb_presents', 'created_at',
        ]
        read_only_fields = ['id', 'created_at']
...
class ConvocationExamenSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'epreuve', 'epreuve_ecue', 'epreuve_date',
            'etudiant', 'etudiant_matricule', 'etudiant_nom',
            'numero_place', 'salle', 'statut', 'statut_display',
            'notifie', 'date_notification',
        ]
        read_only_fields = ['id']
