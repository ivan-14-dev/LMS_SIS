...
class DiplomeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'type', 'type_display', 'nom', 'niveau_grade',
            'code_rncp', 'credits_ects', 'conditions', 'created_at',
        ]
...
class CessionDiplomeListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'date_obtention', 'mention', 'moyenne_finale',
        ]
...
class CessionDiplomeDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'annee_universitaire', 'annee_libelle',
            'date_obtention', 'mention', 'moyenne_finale',
            'numero_serie', 'pdf_path',
            'signe_par', 'signe_par_nom', 'date_signature',
            'qr_verification', 'created_at',
        ]
