...
class Diplome(models.Model):
    ...
    niveau_grade = models.CharField(max_length=50, help_text="Ex: Licence, Master, Doctorat")
    code_rncp = models.CharField(max_length=20, blank=True, help_text="Code RNCP France")
...
class CessionDiplome(models.Model):
    ...
    etudiant = models.ForeignKey(Etudiant, on_delete=models.CASCADE, related_name="diplomes_obtenus")
    diplome = models.ForeignKey(Diplome, on_delete=models.PROTECT, related_name="cessions")
    ...
    moyenne_finale = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
