...
from .models import SujetMemoire, Memoire, JuryMemoire
...
class SujetMemoireListSerializer(serializers.ModelSerializer):
    ...
    encadreur_nom = serializers.CharField(source='encadreur.user.get_full_name', read_only=True)
    ...
    class Meta:
        model = SujetMemoire
        fields = [
            'id', 'formation', 'formation_nom', 'titre',
            'encadreur_nom', 'statut', 'statut_display',
            'nb_etudiants_max', 'nb_candidats',
...
class SujetMemoireDetailSerializer(serializers.ModelSerializer):
    ...
    formation_nom = serializers.CharField(source='formation.nom', read_only=True)
    encadreur_nom = serializers.CharField(source='encadreur.user.get_full_name', read_only=True)
    co_encadreur_nom = serializers.CharField(source='co_encadreur.user.get_full_name', read_only=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            'annee_universitaire', 'titre', 'description', 'mots_cles',
            'encadreur', 'encadreur_nom',
            'co_encadreur', 'co_encadreur_nom',
            'laboratoire', 'laboratoire_nom',
            'nb_etudiants_max', 'prerequis',
            'statut', 'statut_display',
            'date_publication', 'date_limite_candidature', 'created_at',
        ]
...
class MemoireListSerializer(serializers.ModelSerializer):
    ...
    encadreur_nom = serializers.CharField(source='sujet.encadreur.user.get_full_name', read_only=True)
    statut_display = serializers.CharField(source='get_statut_display', read_only=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            'sujet', 'sujet_titre', 'encadreur_nom',
            'statut', 'statut_display', 'date_depot',
        ]
...
class MemoireDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Memoire
        fields = [
            'id', 'sujet', 'sujet_titre',
            'etudiant', 'etudiant_matricule', 'etudiant_nom',
            'fichier', 'resume', 'abstract',
            'date_depot', 'rapport_similarite',
            'statut', 'statut_display',
...
class JuryMemoireSerializer(serializers.ModelSerializer):
    ...
    etudiant_nom = serializers.CharField(source='memoire.etudiant.user.get_full_name', read_only=True)
    ...
    class Meta:
        model = JuryMemoire
        fields = [
            'id', 'memoire', 'memoire_titre', 'etudiant_nom',
            'president', 'president_nom',
            'rapporteurs', 'rapporteurs_list',
            'autres_membres', 'created_at',
        ]
        read_only_fields = ['id', 'created_at']
