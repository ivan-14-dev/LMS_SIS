...
class UtilisateurDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'role', 'role_display', 'etablissement', 'numero_etudiant',
            'numero_enseignant', 'telephone', 'adresse', 'photo', 'langue',
            'mfa_active', 'doit_changer_mdp', 'derniere_connexion',
            'preferences_notification', 'is_active', 'date_joined',
            'is_etudiant', 'is_enseignant', 'is_admin',
        ]
        read_only_fields = [
            'id', 'full_name', 'role_display', 'derniere_connexion',
            'date_joined', 'is_etudiant', 'is_enseignant', 'is_admin',
        ]
        extra_kwargs = {
...
class UtilisateurCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'first_name', 'last_name', 'role', 'etablissement',
            'telephone', 'langue',
        ]
...
class UtilisateurProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'photo', 'langue', 'preferences_notification',
        ]
