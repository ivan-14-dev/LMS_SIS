...
class FormationListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Formation
        fields = [
            'id', 'code', 'nom', 'type', 'type_display',
            'niveau', 'niveau_display', 'duree_annees', 'credits_total',
            'departement', 'departement_nom',
            'responsable', 'responsable_nom', 'actif',
        ]
...
class FormationDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'code', 'nom', 'type', 'type_display',
            'niveau', 'niveau_display', 'duree_annees', 'nb_semestres', 'credits_total',
            'departement', 'departement_nom', 'ecole_doctorale',
            'responsable', 'responsable_nom',
            'regime', 'regime_display', 'accreditations',
            'date_accreditation', 'date_fin_accreditation',
            'description', 'objectifs', 'debouches', 'conditions_admission',
            'actif', 'nb_parcours', 'created_at', 'updated_at',
        ]
...
class ParcoursSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Parcours
        fields = [
            'id', 'formation', 'formation_nom', 'formation_code',
            'code', 'nom', 'specialisation', 'description',
            'created_at',
        ]
