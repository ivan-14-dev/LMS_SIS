...
from .models import ReleveNotes, Transcript, Attestation
...
class ReleveNotesListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'classement', 'effectif',
            'date_emission', 'signe', 'numero_serie',
        ]
...
class ReleveNotesDetailSerializer(serializers.ModelSerializer):
    ...
    etudiant_nom = serializers.CharField(source='etudiant.user.get_full_name', read_only=True)
    semestre_nom = serializers.CharField(source='semestre.__str__', read_only=True)
    signe_par_nom = serializers.CharField(source='signe_par.get_full_name', read_only=True)
    ...
    class Meta:
        ...
        fields = [
            'id', 'etudiant', 'etudiant_matricule', 'etudiant_nom',
            'semestre', 'semestre_nom',
            'pdf_path', 'moyenne_generale', 'mention',
            'credits_total', 'credits_valides',
            'classement', 'effectif',
            'date_emission', 'signe', 'date_signature',
            'signe_par', 'signe_par_nom',
            'numero_serie', 'qr_verification', 'created_at',
        ]
...
class TranscriptListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'etudiant', 'etudiant_matricule', 'etudiant_nom',
            'nb_annees', 'credits_total', 'credits_valides',
            'moyenne_ponderee', 'mention_finale',
            'diplome_prepare', 'date_emission', 'numero_serie',
        ]
...
class TranscriptDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'etudiant', 'etudiant_matricule', 'etudiant_nom',
            'annees', 'annees_list',
            'pdf_path', 'credits_total', 'credits_valides',
            'moyenne_ponderee', 'mention_finale',
            'diplome_prepare', 'date_emission', 'numero_serie',
            'signe_par', 'signe_par_nom', 'created_at',
        ]
        read_only_fields = ['id', 'created_at']
...
class AttestationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'etudiant', 'etudiant_matricule', 'etudiant_nom',
            'type', 'type_display',
            'pdf_path', 'date_emission', 'date_validite',
            'numero', 'signe_par', 'signe_par_nom', 'created_at',
        ]
        read_only_fields = ['id', 'created_at']
