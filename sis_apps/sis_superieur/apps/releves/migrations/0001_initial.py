    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credits_total', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credits_valides', models.DecimalField(decimal_places=2, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('reussite', 'Attestation de réussite'), ('inscription', "Attestation d'inscription"), ('comparabilite', 'Attestation de comparabilité'), ('relevé_notes', 'Demande de relevé'), ('diplome', 'Attestation de diplôme'), ('stage', 'Attestation de stage'), ('mobilite', 'Attestation de mobilité')], max_length=30)),
                ('pdf_path', models.CharField(max_length=500)),
                ('date_emission', models.DateField()),
                ('date_validite', models.DateField(blank=True, null=True)),
                ('numero', models.CharField(max_length=50, unique=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('etudiant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attestations', to='etudiants.etudiant')),
            ],
            options={
