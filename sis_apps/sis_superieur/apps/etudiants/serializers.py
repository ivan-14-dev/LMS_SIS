...
class EtudiantListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'statut', 'statut_display', 'regime', 'boursier',
        ]
...
class EtudiantDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Etudiant
        fields = [
            'id', 'user', 'universite', 'matricule', 'ine',
            'date_naissance', 'lieu_naissance', 'sexe', 'sexe_display',
            'nationalite', 'adresse', 'code_postal', 'ville', 'pays',
            'telephone', 'email_personnel', 'statut', 'statut_display',
            'regime', 'regime_display', 'boursier', 'date_premiere_inscription',
            'annee_universitaire_actuelle', 'annee_universitaire_libelle',
            'photo', 'contact_urgence_nom', 'contact_urgence_tel',
...
class EtudiantCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'universite', 'matricule', 'ine', 'date_naissance', 'lieu_naissance',
            'sexe', 'nationalite', 'adresse', 'code_postal', 'ville', 'pays',
            'telephone', 'email_personnel', 'regime', 'boursier',
        ]
...
class InscriptionAdministrativeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'annee_universitaire', 'formation', 'formation_nom', 'parcours',
            'date_inscription', 'statut', 'statut_display', 'regime',
            'bourse_id', 'pieces_fournies', 'payeur', 'motif_refus',
            'created_at', 'updated_at',
        ]
...
class EtudiantSearchSerializer(serializers.Serializer):
    ...
    q = serializers.CharField(required=False, help_text="Recherche par nom, prénom ou matricule")
