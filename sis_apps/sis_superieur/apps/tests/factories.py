...
import factory
from apps.etablissement.models import AnneeUniversitaire, Domain, Semestre, Universite
from apps.etudiants.models import Etudiant, InscriptionAdministrative
from apps.formations.models import Formation, MaquetteFormation, Parcours
from apps.integration.models import EdxCourseMapping, EdxEnrollment, EdxUserMapping, OutboxEvent
from apps.structure.models import Departement, EcoleDoctorale, Faculte
