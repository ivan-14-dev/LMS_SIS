...
class EntrepriseListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Entreprise
        fields = [
            'id', 'raison_sociale', 'type', 'type_display',
            'secteur', 'secteur_display',
            'ville', 'pays', 'taille',
            'nb_contacts', 'nb_offres', 'actif',
        ]
...
class EntrepriseDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'raison_sociale', 'type', 'type_display',
            'siret', 'siren', 'tva_intracommunautaire',
            'secteur', 'secteur_display', 'description', 'site_web',
            'adresse', 'code_postal', 'ville', 'pays',
            'telephone', 'email', 'logo', 'taille',
            'nb_contacts', 'nb_offres', 'actif',
            'cree_le', 'modifie_le',
        ]
