    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "volume_horaire_cm",
                    models.PositiveIntegerField(default=0, help_text="Heures CM"),
                ),
                (
                    "volume_horaire_td",
                    models.PositiveIntegerField(default=0, help_text="Heures TD"),
                ),
                (
                    "volume_horaire_tp",
                    models.PositiveIntegerField(default=0, help_text="Heures TP"),
                ),
                (
                    "mh_global",
                    models.CharField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="ues",
                        to="formations.maquetteformation",
                    ),
                ),
                (
                    "parcours_autorises",
                    models.ManyToManyField(
                        blank=True, related_name="ues", to="formations.parcours"
                    ),
                ),
                (
                    "semestre",
