...
class BilansECTSViewSet(viewsets.ModelViewSet):
    ...
    filterset_fields = ['etudiant', 'annee_universitaire', 'inscription_admin__formation']
    ...
    def par_etudiant(self, request):
        ...
        bilans = self.get_queryset().filter(etudiant_id=etudiant_id).order_by('-annee_universitaire__date_debut')
    ...
    def statistiques(self, request):
        ...
        stats['taux_validation_global'] = (
            ...
            if stats['total_inscrits'] else 0
        )
